...
public class Mail {
    ...
    public static String myEmailAccount = "1840278312@qq.com";
    public static String myEmailPassword = "euyuvwknozeadjij";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "silver@tomsonsofa.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String content) throws Exception {
        ...
        message.setSubject("您关注的大佬发言啦", "UTF-8");
